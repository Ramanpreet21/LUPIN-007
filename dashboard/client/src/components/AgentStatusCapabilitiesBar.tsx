...
export function AgentStatusCapabilitiesBar({ data, onToggleApprovalMode, onEmergencyStop, onSSHAction, onSkillClick, className = "", models, onModelChange, targets, onTargetChange }: AgentStatusCapabilitiesBarProps) {
